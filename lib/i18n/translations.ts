...
export const translations = {
  ...
  "nav.webRedirect": { en: "WEB-01 Redirect", zh: "WEB-01 網頁轉導" },
  "nav.ticket": { en: "ATH-01 Ticket", zh: "ATH-01 票證" },
  "nav.push": { en: "ATH-03 Push", zh: "ATH-03 推播" },
  "nav.batch": { en: "ATH-04 Batch", zh: "ATH-04 連續簽章" },
  "nav.result": { en: "ATH-02 Result", zh: "ATH-02 結果查詢" },
  "nav.deviceStatus": { en: "LF-01 Device", zh: "LF-01 裝置狀態" },
  "nav.appLink": { en: "APP-API-01 Link", zh: "APP-API-01 深層連結" },
